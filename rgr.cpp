...
int main()
{
    ...
    cout << endl << "Двойная табличная перестановка:" << endl;
    cout << "Введите ключ:";
    getline(cin, key);
    slovo = DoubleTableSwapEncrypt(text, key);
    cout << endl << "Зашифрованное сообщение: \"" << slovo << "\"" << endl;
    slovo = DoubleTableSwapDecrypt(slovo, key);
    cout << "Расшифрованное сообщение:" << slovo << endl;
}
